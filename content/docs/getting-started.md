...
This documentation section is useful when you want to learn more details about a particular React API. For example, [`Hooks` API Reference](/docs/hooks-reference.html) can provide you with details on how `useState()` works, and what different `useEffect` is useful for.
